...
DEFINE_FIELD_X(LevelInfo, level_info_t, wiflags)
...
DEFINE_FIELD_BIT(FLevelLocals, wiflags, nototaltime, WIFLAGS_CUTSCENELEVEL)
DEFINE_FIELD_BIT(FLevelLocals, wiflags, noautosaves, WIFLAGS_NOAUTOSAVES)
DEFINE_FIELD_BIT(FLevelLocals, wiflags, cutscenelevel, WIFLAGS_CUTSCENELEVEL)
